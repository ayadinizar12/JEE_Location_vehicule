...
public class reservation_liste extends JFrame  {
	...
	public void initTable(){
		...
		try {
			...
			result.add(new JLabel("La demande a ete executer en " + totalTime + " ms et a retournee " + rowCount + " ligne(s)"), BorderLayout.SOUTH);
			result.revalidate();
			...
			JOptionPane.showMessageDialog(null, e.getMessage(), "ERREUR ! ", JOptionPane.ERROR_MESSAGE);
                ...
                Logger.getLogger(reservation_liste.class.getName()).log(Level.SEVERE, null, ex);
            }	
