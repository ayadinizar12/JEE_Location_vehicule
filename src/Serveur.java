...
public class Serveur extends JFrame {
	...
	private JMenu fichier = new JMenu("Base de donnees");
	...
	private JMenuItem liste_connecte = new JMenuItem("Liste des connect�s");
	...
	private JMenuItem fermer = new JMenuItem("Deconnecter");
...
public Serveur(){
	...
	// LISTE VEHICULE
		...
		bdd.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				BDD zd = new BDD(null, "Informations base de donnee", true);
...
state5.close();
			...
			JLabel lib = new JLabel("Membres connectes : "+ rowCount );
			...
			JLabel lib4 = new JLabel("Nombre de vehicule reserves : "+ rowCount4 );
			...
			JLabel label2 = new JLabel("Informations :");
			...
			pan.add(lib4);
			pan.add(lib5);
			JLabel label = new JLabel("Pour d buter consulter la barre d'outil !");
			...
			this.getContentPane().add(new JLabel("Progiciel repartie - Programmer en java evenementielle par Nizar AY - Copie non autorise"), BorderLayout.SOUTH);
...
public static void main(String [] args)
{
 try {
	 ...
	 JOptionPane confirmation = new JOptionPane();
		confirmation.showMessageDialog(null, "Le serveur a d�marrer ", "Connexion �tablie", JOptionPane.INFORMATION_MESSAGE, img);
	
	
	BDD zd = new BDD(null, "Configuration de la base de donn�e", true);
