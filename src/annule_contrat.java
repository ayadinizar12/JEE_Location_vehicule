	...
	try{ 
            ...
            try{
                ...
                if(id !=null) {
                    ...
                    int option = jop.showConfirmDialog(null, "etes-vous sur de vouloir annuler le contrat avec le client "+str[1]+" "+str[2]+" ?", "Confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    ...
                    if(option == JOptionPane.OK_OPTION)
                    {
                        ...
                        try{
                            ...
                            confirmation.showMessageDialog(null, "Le contrat a ete annuler ", "Annulation contrat", JOptionPane.INFORMATION_MESSAGE, null);
            ...
            res.close();
            state.close();
	}catch(ClassNotFoundException ex) {Logger.getLogger(annule_contrat.class.getName()).log(Level.SEVERE, null, ex);
}
