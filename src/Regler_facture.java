...
//info client
		...
		int prixht = qte*pri;
	    int ttc = tva+prixht;
		Object[][] data = {	{id, "Reservation de voiture", "marque","Modele",prix+",00  ",qte,tva+",00  ",prixht+",00  ", ttc+",00  "}
			
		};

		String  title[] = {"Ne","Designation","marque","Modele","Prix Unitaire", "Qte","TVA","Prix HT","TTC"};
		int Timbre = 400;
      ...
      try {
			...
			*/
			...
			e1.printStackTrace();
                  ...
                  Logger.getLogger(Regler_facture.class.getName()).log(Level.SEVERE, null, ex);
              }
    }
