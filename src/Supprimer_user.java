...
public class Supprimer_user {
	...
	try{
            ...
            try{
                ...
                int option = jop.showConfirmDialog(null, "etes-vous sur de vouloir supprimer l'utilisateur "+login+" ?", "Confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                ...
                confirmation.showMessageDialog(null, "L'utilisateur a ete supprimer ", "Mise a ajour", JOptionPane.INFORMATION_MESSAGE, null);
		...
		Logger.getLogger(Supprimer_user.class.getName()).log(Level.SEVERE, null, ex);
