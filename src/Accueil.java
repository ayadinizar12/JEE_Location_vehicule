...
public class Accueil extends JFrame {
	...
	private JMenuItem bdd = new JMenuItem("Base de donnees");
	private JMenu aide = new JMenu("Aide");
	private JMenu user = new JMenu("Utilisateurs");
	public static String adr;
	private JMenu config = new JMenu("Parametres");
	...
	private static JMenuItem liste_poste = new JMenuItem("Liste des membres connectes");
	private JMenuItem liste_tout = new JMenuItem("Liste du groupe ");
	...
	static JMenuItem liste_voiture_reserve = new JMenuItem("Liste des vehicule reserves");
	...
	private JMenuItem liste_des_reservation = new JMenuItem("Liste des reservation");
	private JMenuItem fermer = new JMenuItem("Fermer");
	private JMenu maj_voiture = new JMenu("Mise a jour");
	private JMenuItem consulter_vehicule = new JMenuItem("Consulter");
	private JMenuItem ajouter_vehicule = new JMenuItem("Creer");
	private JMenuItem modifier_vehicule = new JMenuItem("Modifier");
	private JMenuItem supprimer_vehicule = new JMenuItem("Supprimer");
	private JMenu maj_user = new JMenu("Mise a jour");
	private JMenuItem consulter = new JMenuItem("Consulter");
	private JMenuItem ajouter = new JMenuItem("Creer");
	...
	public Accueil(){
		...
		this.setTitle("Location_vehicule ");
		...
		bon_de_reservation.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					try {
						Reserva l = new Reserva(null, "Reservation : Informations Vehicule", true);
					} catch (RemoteException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
...
vehicule(requete);
	...
	/*commander.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				Client zd = new Client(null, "Commander V�hicule", true);
...
JLabel lib4 = new JLabel("Vehicule reserves:");
JLabel lib3 = new JLabel("Vehicule sorties:" );
JLabel lib6 = new JLabel("Nombre de reservation:");
...
bdd.addActionListener(new ActionListener(){
	...
	public void actionPerformed(ActionEvent arg0) {
		BDD zd = new BDD(null, "Parametres : Informations base de donnee", true);
...
//contient.add(new JLabel("Progiciel r�partie - Programmer en java �venementielle par REFES Chabane - Copie non autoris�"), BorderLayout.SOUTH);
this.setContentPane(split);
	...
	public static void main(String[] args) throws UnknownHostException, MalformedURLException, RemoteException, NotBoundException, InterruptedException{
		BDD zd = new BDD(null, "Etape 1/2 : Configuration de la base de donnee", true);
...
private Color fondBouton = Color.white;
	 ...
	 private void initToolBar(){
		 ...
		 icone_reserva.setToolTipText("Faire une nouvelle reservation");
		 change_onglet.setToolTipText("Changer la position de l'onglet");
		 reservee.setToolTipText("Afficher la liste des reservation");
		 facture1.setToolTipText("Afficher la liste des factures");
		 client_attente.setToolTipText("Afficher la liste des clients ayant reservee");
		 client_contrat.setToolTipText("Afficher la liste des clients sous contrats");
		 reserve.setToolTipText("Afficher la liste des vehicules en reservation");
 	...
 	synchronized public void marques() throws RemoteException {
 		...
 		try {
 			Location l = new Location(null, "Contrat : Informations Vehicule", true);
