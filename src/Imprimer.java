...
import java.util.logging.Logger;
  ...
  {  
    ...
    Imprimer()
    {
    	...
    	setTitle("Reservation d'un vehicule");
    	Border[] listBorder = {	
...
//info client
		...
		int prixht = qte*pri;
	    int ttc = tva+prixht;
		Object[][] data = {	{"Reservation de voiture", marque,modele,prix+",00  ",qte,tva+",00  ",prixht+",00  ", ttc+",00  "}
			
		};

		String  title[] = {"Designation ","marque ","Modele ","Prix Unitaire ", "Qte ","TVA ","Prix HT ","TTC "};
		int Timbre = 400;
    ...
    JTable tableau2 = new JTable(data2, title2);
		...
		String str = "Remarque : La societe n'est pas responsable de la non ";
		String str1 = "disponibilte de la voiture a cause d'un retard faite par un client ";
		String str2 = "En cas ou le locataire annule sa reservation, la societe ";
		String str3 = "a le droit de garder 40% du montant paye ";
