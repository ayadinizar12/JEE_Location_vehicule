...
public class Liste_connecte extends JFrame {
	...
	public void initTable(){
		...
		try {
			...
			result.add(new JLabel("La demande a ete executer en " + totalTime + " ms et a retourne " + rowCount + " ligne(s)"), BorderLayout.SOUTH);
			result.revalidate();
			...
			JOptionPane.showMessageDialog(null, e.getMessage(), "ERREUR ! ", JOptionPane.ERROR_MESSAGE);
                ...
                Logger.getLogger(Liste_connecte.class.getName()).log(Level.SEVERE, null, ex);
            }	
