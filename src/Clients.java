...
public class Clients extends JDialog {
	...
	private void initComponent(){
		...
		panPrenom.setBorder(BorderFactory.createTitledBorder("Prenom du client "));
		...
		panNss.setBorder(BorderFactory.createTitledBorder("Numero CIN "));
		nssLabel = new JLabel("CIN : ");
		...
		panTelephone.setBorder(BorderFactory.createTitledBorder("Numero de telephone du client "));
		...
		panNumero_permis.setBorder(BorderFactory.createTitledBorder("Numero du permis de conduire "));
		npLabel = new JLabel("Numero permis : ");
		...
		okBouton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent arg0) {		
				...
				setVisible(false);
			      EssaiImprimer i = new EssaiImprimer( numero,marque, modele,etat,kilometrage, prix, nom.getText(), prenom.getText(), securite_social.getText(), adresse.getText(), telephone.getText(), numero_permis.getText());
