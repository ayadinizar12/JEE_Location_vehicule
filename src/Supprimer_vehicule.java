...
public class Supprimer_vehicule {
	...
	try{
            ...
            try{
                ...
                int option = jop.showConfirmDialog(null, "etes-vous sur de vouloir supprimer le modele "+modele+" ?", "Confirmation de suppression", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                ...
                if(option == JOptionPane.OK_OPTION)
                {
                    ...
                    try{
                        ...
                        confirmation.showMessageDialog(null, "Le vehicule a ete supprimer ", "Mise a ajour", JOptionPane.INFORMATION_MESSAGE, null);
	...
	}catch(ClassNotFoundException ex){Logger.getLogger(Supprimer_vehicule.class.getName()).log(Level.SEVERE, null, ex);
}
