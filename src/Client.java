...
public class Client extends JDialog {
	...
	private void information(){
		...
		okBouton.addActionListener(new ActionListener(){
			...
			confirmation.showMessageDialog(null, "Vous etes connecter", "Connexion etablie", JOptionPane.INFORMATION_MESSAGE, img);
			new Accueil(true);
			}
			else {
				
				ImageIcon img = new ImageIcon("images/erreur.png");
			erreur.showMessageDialog(null, "Erreur dans le login et le mot de passe", "Connexion echoue", JOptionPane.ERROR_MESSAGE, img);
